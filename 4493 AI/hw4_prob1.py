...
class TSP:
    def __init__(self, cities):
        ...
        self.T = 2.0
        self.alpha = 0.99
        self.max_iter = 10**6   # you can increase this if you want better results
    ...
    def solve(self):
        ...
        for it in range(self.max_iter):
            ...
            # Optional: progress feedback every 10,000 iterations
            if (it + 1) % 10000 == 0:
                print(f"Iteration {it+1}/{self.max_iter} | Best length: {self.best_length:.4f}")
        
        print(f"\nFinished! Best tour length found: {self.best_length:.4f}")
        return self.best_tour, self.best_length

    def plot(self):
        """Plot the best tour using matplotlib (required by your homework)"""
...
# ============================
# How to use the class (very simple!)
# ============================

# Paste your 20 cities here (2 rows × 20 columns)
cities = np.array([
...
# Display the path (this is what your homework asks for)
solver.plot()
